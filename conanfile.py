...
class ClustersFromPointsPluginConan(ConanFile):
    ...
    name = "ClustersFromPointsPlugin"
    description = "A Plugin for creating clusters based on point data values in the high-dimensional plugin system (HDPS)."
    topics = ("hdps", "plugin", "clustering", "data")
    url = "https://github.com/hdps/ClustersFromPointsPlugin"
    ...
    def _configure_cmake(self, build_type):
        ...
        cmake.configure(source_folder="hdps/ClustersFromPointsPlugin")  # needed for scm
        cmake.verbose = True
        return cmake
